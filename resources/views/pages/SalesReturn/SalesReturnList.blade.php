...
<form id="list_data" method="get" action="{{isset($excution) ? route('sales_return.sales_return_list', ['excution' => 'execution']) : route('sales_return.index') }}" class="p-3 bg-light border rounded">
    <div class="row g-3 align-items-end">
        <!-- From Date -->
        <div class="col-md-2">
            <label class="form-label fw-bold" for="start-date">From</label>
            <input type="date" value="" class="form-control" name="from" placeholder="Start date" required>
        </div>

        <!-- To Date -->
        <div class="col-md-2">
            <label class="form-label fw-bold" for="end-date">To</label>
            <input type="date" value="" class="form-control" name="to" placeholder="End date" required>
        </div>
