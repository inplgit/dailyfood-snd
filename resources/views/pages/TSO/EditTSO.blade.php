                    ...
                    <div class="col-md-3 col-12">
                        <div class="form-group">
                            ...
                            <input type="checkbox"  
                                ...
                                value="1" 
                                {{ $tso->locations->count() > 0 ? 'checked' : '' }}>
                        </div>
                    </div>
                </div>

<div class="row get_location" style="{{ $tso->locations->count() > 0 ? '' : 'display:none;' }}">
    <div class="col-md-12">
        ...
        <div id="locations_wrapper">
            {{-- Existing Locations --}}
            @if($tso->locations->count())
                @foreach($tso->locations as $index => $location)
