        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">ADD SCHEME PRODUCT PCS</h4>
                </div>
                <div class="card-body">
                    <form id="subm" method="POST" action="{{ route('store_pcs') }}" class="form" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-2">
                                <div class="main_head">
                                    ...
                                    <div class="col-md-12 col-12 append_price_data">
                                            <div class="row remove_data">
                                                ...
                                                <div class="col-md-3 col-3">
                                                    ...
                                                    <input name="scheme_Pcs[0]" required type="number" step="any" placeholder="Scheme Pcs" class="form-control"/>
                                                </div>
                                                <div class="col-md-2 col-2">
