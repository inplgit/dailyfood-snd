        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Edit SCHEME PRODUCT PCS</h4>
                </div>
                <div class="card-body">
                    <form id="subm" method="POST" action="{{ route('store_pcs_update',$scheme_product->id) }}" class="form" >
                        @method('PUT')
                        @csrf
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea  name="description"  class="form-control" value="{{$scheme_product->description}}" placeholder="Scheme Description">{{$scheme_product->description}}</textarea>
                                        </div>
                                    </div>

 				 <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        <label class="control-label">Start Date <strong>*</strong></label>
                                        <input name="start_date" type="date" value="{{$scheme_product->start_date}}" class="form-control" required />
                                    </div>
                                </div>

                                <div class="col-md-3 col-12">
                                    <div class="form-group">
                                        <label class="control-label">End Date <strong>*</strong></label>
                                        <input name="end_date" type="date" value="{{$scheme_product->end_date}}"class="form-control" required />
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-12 append_price_data">
                                            <div class="row ">
                                                ...
                                                <div class="col-md-3 col-3">
                                                    <label class="control-label">Scheme Pcs</label>
                                                </div>
                                            </div>
                                            @php
                                                $rowIndex = 0;
                                            ...
                                            @foreach ($scheme_product->SchemeProductData as $data)
                                                ...
                                                <div class="row mt-2 remove_data">
                                                    ...
                                                    <div class="col-md-3 col-3">
                                                        <input name="scheme_Pcs[{{$rowIndex}}]" required type="number" value="{{$data->scheme_Pcs}}" step="any" placeholder="Scheme Amount" class="form-control"/>
                                                    </div>
    ...
    function addMore()
    {
        html = `
         <div class="row mt-2 remove_data">
                                                ...
                                                <div class="col-md-3 col-3">
                                                    <input name="scheme_Pcs[${rowIndex}]" required type="number" step="any" placeholder="Scheme PCs" class="form-control"/>
                                                </div>
                                                <div class="col-md-1 col-1">
                                                    <button class="btn btn-sm btn-danger" type="button" onclick="removeMore(this)">Remove</button>
                                                </div>
