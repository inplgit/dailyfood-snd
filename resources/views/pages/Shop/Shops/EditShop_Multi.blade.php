...
<section id="multiple-column-form">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form id="subm" method="post" action="{{ route('shop_update_multi',$shop->id) }}" class="form">
                                            @method('PUT')
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="row">
                                                  ...
                                                  <div class="col-md-3 col-12">
                                                    <div class="form-group">
                                                        <label>TSO</label>
                                                        <select  onchange="get_route_by_tso()" name="tso_id[]" multiple id="tso_id" class="select2 form-control form-control-lg">
                                                            @foreach ($master->get_all_tso_by_distributor_id($shop->distributor_id) as $row)
                                                                <option value="{{ $row->id }}" 
                                                                    @if($shop->tsos->contains('id', $row->id)) selected @endif>
                                                                    {{ $row->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                  ...
                                                  <div class="col-md-3 col-12">
                                                        <div class="form-group">
                                                            <label>Route</label>
                                                           <select onchange="get_sub_routes()" id="route_id" name="route_id"
        class="select2 form-control form-control-lg">
    @if ($shop->route_id)
        <option value="{{ $shop->route_id }}">
    ...
    // Your existing shopLocation function
    shopLocation();
});
