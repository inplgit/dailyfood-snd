                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form id="subm" method="post" action="{{ route('store_multi') }}" class="form">
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="main_head">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <select onchange="get_route_by_tso()" name="tso_id[]" multiple id="tso_id" class="tso-id select2 form-control form-control-lg">
                                                                </select>
