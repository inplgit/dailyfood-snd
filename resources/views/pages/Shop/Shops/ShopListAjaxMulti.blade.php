                ...
                <table id="dataTable" class="table table-bordered">
                    ...
                    <tbody id="data">
                        ...
                        <tr>
                            ...
                            <td>{{$active_status ?? ''}}</td>
<td>
<img src="{{ asset('storage/shop_image/' . $shop->image) }}" width="100px" height="200px">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu_sale_order_list" aria-labelledby="dropdownMenuButton">
                                        ...
                                        @can('Shop_Edit')
                                            <a href="{{ route('shop_edit_multi', $row) }}" class="dropdown-item_sale_order_list dropdown-item">Edit</a>
                                        @endcan
                                        @can('Shop_Delete')
