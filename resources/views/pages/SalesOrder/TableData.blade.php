            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu_sale_order_list" aria-labelledby="dropdownMenuButton">
                    @can('Sale_Order_VIew')
                        ...
                        <a target="_blank" data-url="{{ route('sale.show', $row->id) }}" data-title="View Sale Order" class="dropdown-item_sale_order_list dropdown-item launcher">View</a>
                    @endcan
                    ...
                    @can('Sale_Order_Delete')
                        ...
                        {{-- <a href="{{ route('sale.destroy', $row->id) }}" data-url="{{ route('sale.destroy', $row->id) }}" id="delete-user" class="dropdown-item_sale_order_list dropdown-item" href="#">Delete</a> --}}
                    @endcan
                    @endif
                </div>
            </div>
