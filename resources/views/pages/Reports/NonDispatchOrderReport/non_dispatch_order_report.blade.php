...
@section('title', 'Non Dispatch Order Report')
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Non Dispatch Order Report</h4>
                        <button type="button" id="exportBtn" onclick="exportBtnWithFilters('Non Dispatch Order Report')" class="btn btn-success">Export Excel</button>
                    </div>
                    <div class="card-body">
                        <form method="get" action="{{ route('non_dispatch_order_report') }}" id="list_data" class="form">
                            @csrf
                            <div class="row">
