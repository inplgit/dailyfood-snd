...
@section('title', 'App Version Report')
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">App Version Report</h4>
                        <button type="button" id="exportBtn" onclick="exportBtn('Version Report')"
                            class="btn btn-success">Export Excel</button>
                    </div>
                    <div class="card-body">
                        <form method="get" action="{{ route('app_version_report') }}" id="list_data" class="form">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select required onchange="get_tso_by_multiple_dis()" multiple class="select2 form-control" name="distributor_id[]"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select required class="form-control" name="designation" id="" required>
                                            <option value="">select</option>
