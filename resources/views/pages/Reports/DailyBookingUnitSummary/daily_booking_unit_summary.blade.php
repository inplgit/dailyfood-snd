...
@section('title', 'Daily Booking Unit Summary')
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Daily Booking Unit Summary</h4>
                        <button type="button" id="exportBtn" onclick="exportBtnWithFilters('Daily Booking Unit Summary')" class="btn btn-success">Export Excel</button>
                    </div>
                    <div class="card-body">
                        <form method="get" action="{{ route('daily_booking_unit_summary') }}" id="list_data" class="form">
                            @csrf
                            <div class="row">
                    ...
                    <!-- <input type="hidden" id="pages" value="1">
                                ...
                                <!-- <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select required class="form-control" name="execution"
                                                id="execution">
                                            <option value="">All</option>
