                    ...
                    <form method="get" action="{{ route('product_wise_sale') }}" id="list_data" class="form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>City </label>
                                    <select onchange="getDistributorByCity()" class="form-control" name="city" id="city" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select required onchange="get_tso_by_multiple_dis()" multiple class="select2 form-control distributor_id" name="distributor_id[]" id="distribuotr_id" required>
                                        <option value="">All</option>
                        ...
                        <div class="row" id="type_data">
                           ...
                           <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    {{-- <select onchange="get_route_by_tso()" class="form-control select2" multiple id="tso_id" name="tso_id[]" required>
