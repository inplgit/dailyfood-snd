...
@if(in_array($user_data->id, [631, 635, 643, 649, 656]))
                                        ...
                                        <ul class="report-list">
                                            ...
                                            <li>
                                                <a href="{{ route('booking_vs_execution') }}">
                                                    <i class="fas fa-circle"></i>
                                                    <span>Booking vs Execution</span>
                                                </a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                             ...
                                             <li>
                                                <a href="{{ route('cancelled_orders_report') }}">
                                                    <i class="fas fa-circle"></i>
                                                    <span>Cancelled Orders Report</span>
                                                </a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                             ...
                                             <li>
                                                <a href="{{ route('order_booker_daily_activity_location_report') }}">
                                                    <i class="fas fa-circle"></i>
                                                    <span>Order Booker Daily Activity Location Report</span>
                                                </a>
                                            </li>
                                             <li>
