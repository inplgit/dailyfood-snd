...
@section('title', 'TSO Sales Return')
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">TSO Sales Return</h4>
                        <button type="button" id="exportBtn" onclick="exportBtnWithFilters('TSO Sales Return')" class="btn btn-success">Export Excel</button>
                    </div>
                    <div class="card-body">
                        <form method="get" action="{{ route('tso_sales_return_report') }}" id="list_data" class="form">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
