        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Order Booker Daily Activity Report</h4>
                    <button type="button" id="exportBtn" onclick="exportBtnWithFilters('Order Booker Daily Activity Report')" class="btn btn-success">Export Excel</button>
                </div>
                <div class="card-body">
                    <form method="get" action="{{ route('order_booker_daily_activity_report') }}" id="list_data" class="form">
                        @csrf
                        <div class="row">
