...
@section('title', 'Shop Wise Sales Report')
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Shop Wise Sales Report</h4>
                        <button type="button" id="exportBtn" onclick="exportBtnWithFilters('Shop Wise Sales Report')" class="btn btn-success">Export Excel</button>
                    </div>
                    <div class="card-body">
                        <form method="get" action="{{ route('shop_wise_sales_report') }}" id="list_data" class="form">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
