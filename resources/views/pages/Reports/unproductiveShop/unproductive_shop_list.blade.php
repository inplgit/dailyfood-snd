            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Unproductive Shop List </h4>
                        <button type="button" id="exportBtn" onclick="exportBtnWithFilters('Unproductive Shop List')"
                            class="btn btn-success">Export Excel</button>
                    </div>
                    <div class="card-body">
                        <form method="get" action="{{ route('unproductive_shop_report') }}" id="list_data" class="form">
                            @csrf
                            <div class="row">
