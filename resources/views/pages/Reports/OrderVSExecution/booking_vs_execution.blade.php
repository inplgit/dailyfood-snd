...
@section('title', 'Booking Vs Execution')
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Booking vs Execution (Order Wise) </h4>
                        <button type="button" id="exportBtn" onclick="exportBtnWithFilters('Order Summary')"
                            class="btn btn-success">Export Excel</button>
                    </div>
                    <div class="card-body">
                        <form method="get" action="{{ route('booking_vs_execution') }}" id="list_data" class="form">
                            @csrf
                            <div class="row">
