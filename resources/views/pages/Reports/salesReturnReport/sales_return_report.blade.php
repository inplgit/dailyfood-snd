            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button" id="exportBtn" onclick="exportBtnWithFilters('Sales Return Report')" class="btn btn-success">Export Excel</button>
                    </div>
                    <div class="card-body">
                        <form method="get" action="{{ route('sales_return_report') }}" id="list_data" class="form">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
