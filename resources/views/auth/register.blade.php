...
<div class="core">
    ...
    <div class="identity">
        <a href="{{ url('/') }}">
            <img src="{{ url('/public/assets/images/dailyfood_logo.jpeg') }}"
                 onerror="this.onerror=null;this.src='{{ asset('logoo.png') }}'">
        </a>
    </div>
    ...
    <p class="powered">
        Powered By
        <strong>
            <a href="https://innovative-net.com/" target="_blank">
                <img style="height:12px;margin-right:-6px;"
                     src="{{ url('/public/assets/images/inon.png') }}">
