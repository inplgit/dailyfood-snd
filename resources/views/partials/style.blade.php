...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{url('/public/assets/vendors/css/extensions/toastr.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ url('/public/assets/vendors/css/editors/quill/katex.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ url('/public/assets/vendors/css/editors/quill/monokai-sublime.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ url('/public/assets/vendors/css/editors/quill/quill.snow.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{url('/public/assets/css/pages/dashboard-ecommerce.css')}}">
    <link rel="stylesheet" type="text/css" href="{{url('/public/assets/css/plugins/charts/chart-apex.css')}}">
    <link rel="stylesheet" type="text/css" href="{{url('/public/assets/css/plugins/extensions/ext-component-toastr.css')}}">
    <link rel="stylesheet" type="text/css" href="{{url('/public/assets/css/pages/page-auth.css')}}">
    <link rel="stylesheet" type="text/css" href="{{url('/public/assets/css/pages/app-email.css')}}">
    <link rel="stylesheet" type="text/css" href="{{url('/public/assets/css/plugins/forms/form-quill-editor.css')}}">
    <!-- END: Page CSS-->
